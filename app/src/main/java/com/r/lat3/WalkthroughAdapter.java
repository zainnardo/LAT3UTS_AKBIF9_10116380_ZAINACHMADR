...
class WalkthroughAdapter extends PagerAdapter{
    ...
    public WalkthroughAdapter(Context mContext, ArrayList<WalkthroughActivity> items) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        View itemView = LayoutInflater.from(mContext).inflate(R.layout.activity_walkthrough, container, false);

        WalkthroughActivity item = onBoardItems.get(position);
